"""
Django settings for event_stats project.
...
SECRET_KEY = 'django-insecure-n4j8d&#mr%5z_(pm$gg^+p@8*hevwsvd)%$$b8^bvotlqe1ruq'
...
WSGI_APPLICATION = 'event_stats.wsgi.application'
